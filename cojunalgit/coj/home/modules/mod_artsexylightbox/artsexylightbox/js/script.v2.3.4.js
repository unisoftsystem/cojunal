  ...
  SexyLightbox = {
    ...
    refresh: function() {
      ...
      asljQuery("a, area").each(function() {
        if (asljQuery(this).attr('data-rel') && new RegExp("^"+self.options.find).test(asljQuery(this).attr('data-rel'))){
    ...
    */
    ...
    getInfo: function (image, id) {
      ...
      IEuta = asljQuery('<a id="'+this.options.name+'-'+id+'" title="'+image.attr('title')+'" data-rel="'+image.attr('data-rel')+'">&nbsp;</a>');
    ...
    show: function(caption, url, rel, force) {
      ...
      if (rel.length > this.options.find.length)
      {
          ...
          asljQuery.each(this.anchors, function(index) {
            if (asljQuery(this).attr('data-rel') == rel) {
          ...
          asljQuery.each(this.anchors, function(index){
            if (asljQuery(this).attr('data-rel') == rel && !exit) {
