  ...
  <div class="itemBody">
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a class="" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
	  ...
	  <?php endif; ?>
		...
		<div class="itemContentFooter">
            ...
            <?php if($this->item->params->get('itemAuthor')): ?>
                <!-- Item Author -->
                <span class="itemAuthor pull-left">
