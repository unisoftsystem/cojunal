...
<div class="ns2-art-controllers">
	...
	<?php /*Next & Previous*/ if ($article_arrows): ?>
		<a class="ns2-art-prev" href="#ns2-art-wrap<?php echo $modId; ?>" data-nsspwalk="prev"><i class="fa fa-angle-double-left"></i></a>				
		<a class="ns2-art-next" href="#ns2-art-wrap<?php echo $modId; ?>" data-nsspwalk="next"><i class="fa fa-angle-double-left"></i></a>
	<?php endif; ?>
	<div style="clear:both"></div>
</div>
<?php endif; ?>
												...
												<?php /*Date type blog*/ if ($article_date_format=='blog'): ?>
													<div class="ns2-date-blog">
														...
														<?php
															...
															echo '<div class="ns2_date_month_year">';
                                                            echo '<span class="ns2_date_month">' . $date_time[1] . '</span>';
                                                            //echo '<span class="ns2_date_year">' . $date_time[2] . '</span>';
                                                            echo '</div>';
														?>
														</div>
                                                        ...
                                                        <div class="comment-block" style="clear:both;">
                                                        <i class="linecon-icon-bubble"></i>
