...
class AdminController extends AdminBaseController {
  ...
  public function actionGet_deudores_mora()
  {
    header('Access-Control-Allow-Origin: *');
    $WalletsTempo = new WalletsTempo();
    echo $this->apiResponse($WalletsTempo->deudores_mora());
  }

  public function actionGet_deudores_cartera()
  {
    header('Access-Control-Allow-Origin: *');
    $WalletsTempo = new WalletsTempo();
    echo $this->apiResponse($WalletsTempo->deudores_cartera());
  }

  public function actionRangeDeudoresMora()
  {
    $this->layout = 'layout_dashboad_profile_admin';
    $WalletsTempo = new WalletsTempo();
    $data = [];
    $currentPage = (isset($_GET['page']) ? $_GET['page'] : 1);
    $data['totalregistros'] = count($WalletsTempo->rangedeudorestotal($_GET['id']));
    $data['rangedeudores'] = $WalletsTempo->rangedeudores($_GET['id'], ($currentPage - 1));
    $data['idGet'] = $_GET['id'];
    $this->render('rangedeudores', $data);
  }

  public function actionGetRangeDeudoresMora($id)
  {
    header('Access-Control-Allow-Origin: *');
    $WalletsTempo = new WalletsTempo();
    echo $this->apiResponse($WalletsTempo->rangedeudores($id));
  }
    ...
    */
    ...
    public function actionclientesSearch()
    {
      $data = [];
      $currentPage = (isset($_GET['page']) ? $_GET['page'] : 1);

      $model = new Campaigns;
      $data['clientesList'] = $model::getClientsConfigSearch(($currentPage - 1), $search);
      $data['clientesNames'] = $model::getClientsNames();
      $data['totalRecords'] = $model::getClientsCount();
      $data['totalRecords'] = $data['totalRecords'][0]['total'];
    ...
    public function actionGetreporteCampanasclientes(){
      $model = new AdvisersBase;
      $multipleRows = $model::reporte_campanas_clientes();
      
      // Nombre del reporte
      $fileName = 'campanas.xlsx';
 ...
 // Creamos el archivo excel
    ...
    public function actionreportesdeudacampanas(){
      $model = new AdvisersBase;
      $multipleRows = $model::reporte_estado_deuda_campanas();
      $xls = array();

      
      foreach( $multipleRows as $lis_deudas){
      $deudores = $model::deudores_campanas_informe($lis_deudas['idWalletByCampaign']);
              if( $lis_deudas['saldoCampana'] == $lis_deudas['totalRecaudado']){
                $estado = "CANCELADA";
              }else{
                $estado = "PENDIENTE";
              }
  ...
  wallets_tempo.commentAsset3 */
          foreach( $deudores as $lis_deudores){
                $xls[] = array('cliente'       => $lis_deudas['campaignName'],
                                ...
                                'direccion'       => $lis_deudores['address'],
                                'telefono'        => $lis_deudores['phone'] ,
                                'correo'          => $lis_deudores['email'],
                                'ciudad'          => $lis_deudores['ciudad'],
                                'producto'        => $lis_deudores['product'],
                                'fecha_vence'     => $lis_deudores['validThrough'],
                                'cuenta_cliente'  => '',
                                'titulo_valor'    => $lis_deudores['titleValue'],
                                'tipo_telefono1'  => $lis_deudores['typePhone1'],
                                'pais'            => $lis_deudores['countryPhone1'],
                                'telefono1'       => $lis_deudores['cityPhone1'],
                                'num_tel1'        => $lis_deudores['phone1'],
                              
                                'tipo_telefono2'  => $lis_deudores['typePhone2'],
                                'pais_2'          => $lis_deudores['countryPhone2'],
                                'telefono2'       => $lis_deudores['cityPhone2'],
                                'num_tel2'        => $lis_deudores['phone2'],
                              
                                'tipo_telefono3'  => $lis_deudores['typePhone3'],
                                'pais_3'          => $lis_deudores['countryPhone3'],
                                'telefono3'       => $lis_deudores['cityPhone3'],
                                'num_tel3'        => $lis_deudores['phone3'],
                              
                                'nombrereferencia'  => $lis_deudores['nameReference1'],
                                'relacionrefe1'     => $lis_deudores['relationshipReferenc1'],
                                'pais'              => $lis_deudores['countryReference1'],
                                'cometario'         => $lis_deudores['commentReference1']);
          }
                       
        //echo $lis_deudas['idWalletByCampaign'];
      ...
      $title = [
        ...
        'Numero Telefono 3',
        'Nombre Referencia 1',
        'Parentesco Referencia 1',
        'Pais Referencia 1',
        'Departamento Referencia 1',
        'Comentarios Referencia 1',
        'Nombre Referencia 2',
        'Parentesco Referencia 2',
        'Pais Referencia 2',
        'Departamento Referencia 2',
        'Comentarios Referencia 2',
        'Nombre Referencia 3',
        'Parentesco Referencia 3',
        'Pais Referencia 3',
        'Departamento Referencia 3',
        'Comentarios Referencia 3',
        'Nombre Correo 1',
        'Nombre Correo 2',
        'Nombre Correo 3',
        'Tipo Direccion 1',
