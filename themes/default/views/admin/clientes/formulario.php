					...
					<form id="campaigns-form" name="campaigns-form" class="formweb" action="<?php echo $action ?>" method="POST">
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="text" required="required" name="Campaigns[name]" id="nombre">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="text" required="required" name="Campaigns[idNumber]" id="nit">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="email" required="required" name="Campaigns[contactEmail]" id="email">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="number" required="required" min="0" step="0.01" name="Campaigns[valueService1]" id="serv1">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="number" required="required" min="0" step="0.01" name="Campaigns[valueService2]" id="serv2">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="number" required="required" min="0" step="0.01" name="Campaigns[fees]" id="hono">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="number" required="required" min="0" step="0.01" name="Campaigns[interest]" id="interes">
							</div>				
						</fieldset>
						...
						<fieldset class="large-12 medium-12 small-12 columns padding">
							...
							<div class="large-6 medium-6 small-12 columns">
								<input type="number" required="required" min="0" step="0.01" name="Campaigns[percentageCommission]" id="comision">
							</div>				
						</fieldset>
						...
						<div class="txt_right block large-12 medium-12 small-12 columns padding">
							<div class="large-9 medium-9 small-12 columns">	
								...
								<input type="hidden" value="" name="editar" id="edit_client">
								<button id="btnSaveInfo" class="btnb waves-effect waves-light">GUARDAR</button>
								<button id="btnNuevo" type="button" class="btnb waves-effect waves-light" style="display:none">Nuevo Cliente</button>
							</div>
						</div>
