...
<head>
  ...
  <link href="<?php echo Yii::app()->baseUrl; ?>/assets/site/css/profile_admin/main.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <section class="content_all">
    ...
    <nav id="nav-mobile" class="side-nav fixed">
      ...
      <ul>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/admin/dashboard' ?>" class="waves-effect waves-light">
            <i class="fa fa-home" aria-hidden="true"></i> Dashboard
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/admin/usuarios' ?>" class="waves-effect waves-light">
            <i class="fa fa-users" aria-hidden="true"></i> Usuarios
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/admin/clientes' ?>" class="waves-effect waves-light">
            <i class="fa fa-home" aria-hidden="true"></i> Clientes
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/admin/campana' ?>" class="waves-effect waves-light">
            <i class="fa fa-home" aria-hidden="true"></i> Campañas
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="<?php echo Yii::app()->baseUrl.'/admin/configuracionmails' ?>" class="waves-effect waves-light">
            <i class="fa fa-home" aria-hidden="true"></i> Config. emails
          </a>
        </li>
        <li>
          <a href="<?php echo Yii::app()->baseUrl;?>/logout" class="waves-effect waves-light">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.7.2/plugins/save/plugin.js"></script>
<!-- <link rel="stylesheet" href="../bower_components/jquery-modal/jquery.modal.min.css" /> -->
