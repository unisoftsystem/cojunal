...
<body>
  ...
  <section class="content_all">
    ...
    <nav id="nav-mobile" class="side-nav fixed">
      ...
      <ul>
      <?php if(Yii::app()->session['cojunal']->status_idStatus == 6 ){?>
        <li><a href="<?php echo Yii::app()->baseUrl;?>/campaign" class="waves-effect waves-light" id="profile"><i class="fa fa-home" aria-hidden="true"></i> Campañas</a></li>
        <li><a href="<?php echo Yii::app()->baseUrl;?>/cartera" class="waves-effect waves-light" id="wallets"><i class="fa fa-users" aria-hidden="true"></i> Cartera</a></li>
      ...
      <?php }else{?>
        <li><a href="<?php echo Yii::app()->baseUrl;?>/dashboard" class="waves-effect waves-light" id="profile"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a></li>
        ...
        <li><a href="<?php echo Yii::app()->baseUrl;?>/agenda" class="waves-effect waves-light" id="tasks"><i class="fa fa-calendar-o" aria-hidden="true"></i> Tareas</a></li>
        <li><a href="<?php echo Yii::app()->baseUrl;?>/formatos" class="waves-effect waves-light" id="formats"><i class="fa fa-file-text-o" aria-hidden="true"></i> Formatos</a></li>        
        <li><a href="<?php echo Yii::app()->baseUrl;?>/logout" class="waves-effect waves-light"><i class="fa fa-lock" aria-hidden="true"></i> Cerrar sesión</a></li>        
      <?php } ?>
      </ul> 
    </nav>
